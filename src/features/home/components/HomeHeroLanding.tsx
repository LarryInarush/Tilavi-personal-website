/**
 * File: `src/features/home/components/HomeHeroLanding.tsx`
 * Purpose:
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="text-xs font-semibold tracking-[0.22em] text-zinc-200 uppercase">
                TheTilavi
              </div>
          ...
          <h1 className="mt-6 text-5xl font-semibold tracking-tight text-zinc-50 sm:text-6xl">
            用照片与动作
            <span className="block text-zinc-200">记录街头与生活</span>
          </h1>
          ...
          <p className="mt-5 max-w-2xl text-sm leading-7 text-zinc-200 sm:text-base">
            ...
            <span className="mt-2 block text-xs leading-6 text-zinc-300 sm:text-sm">
              I build with code, shoot with a lens, and learn on a board—sharing
              composition studies, gear notes, trick breakdowns, and thoughts.
            </span>
          </p>
